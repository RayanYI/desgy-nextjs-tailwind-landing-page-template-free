...
const Hero = () => {
  const sitesCount = useCounter(50, 2000)
      ...
      <div className='container mx-auto pt-28 pb-20 max-w-7xl px-4 relative z-10'>
        ...
        >
          <div className='col-span-12 lg:col-span-6'>
            <motion.div variants={itemVariants} className='py-2 px-5 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/40 dark:to-indigo-900/40 rounded-full w-fit mb-6 mx-auto lg:mx-0 border border-blue-200/50 dark:border-blue-700/50'>
            ...
            <motion.h1 variants={itemVariants} className='text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 dark:text-white leading-[1.1] mb-8 text-center lg:text-start'>
            ...
            <motion.p variants={itemVariants} className='text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-10 max-w-lg leading-relaxed text-center lg:text-start mx-auto lg:mx-0'>
            ...
            {/* Animated Stats */}
            <motion.div variants={itemVariants} className='grid grid-cols-3 gap-4 max-w-md mx-auto lg:mx-0'>
              <div className='text-center lg:text-left'>
                <div className='text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white'>
                  {sitesCount}<span className='text-blue-600'>+</span>
                </div>
                <p className='text-sm text-gray-500 dark:text-gray-400'>Sites livrés</p>
              </div>
              <div className='text-center lg:text-left border-l border-gray-200 dark:border-gray-700 pl-4'>
                ...
                <p className='text-sm text-gray-500 dark:text-gray-400'>Délai moyen</p>
              </div>
              <div className='text-center lg:text-left border-l border-gray-200 dark:border-gray-700 pl-4'>
                <div className='text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white'>
                  {scoreCount}<span className='text-blue-600'>/100</span>
                </div>
                <p className='text-sm text-gray-500 dark:text-gray-400'>PageSpeed</p>
              </div>
            </motion.div>
          </div>
