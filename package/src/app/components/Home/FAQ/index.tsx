        ...
        <div className='max-w-3xl mx-auto space-y-4'>
          {faqData.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className={`group rounded-2xl border-2 ${isOpen
              ...
              >
                ...
                >
                  {/* Icon */}
                  <div className={`flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center ${isOpen
                  ...
                  <div className='flex-1 min-w-0'>
                    <span className={`block text-lg font-bold ${isOpen
                  ...
                  {/* Arrow */}
                  <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${isOpen
